...
<template>
  <div class="min-h-screen h-auto w-full flex flex-col relative">
    ...
    <div
      class="w-full min-h-screen bg-emerald-500 flex flex-col justify-start pt-2 items-center"
    >
      <div class="w-11/12 lg:w-1/2 bg-slate-100 rounded-md p-3 mb-6">
        ...
        >
          ...
          <router-link
            class="text-base hover:text-red-700 transition-all duration-200 no-underline text-gray-800"
            to="/test"
