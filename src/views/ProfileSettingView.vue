...
<template>
  <div class="min-h-screen h-full pb-20" id="userMain">
    <NewStickyHeader />
    <div
      id="layout"
    ...
    >
      ...
      <div class="bg-slate-200 shadow py-2 px-2 pt-3 rounded-md">
        ...
        <div class="flex flex-col">
          ...
          <div class="flex flex-col mb-3">
            <form class="w-full px-9" action="#" method="post">
              ...
              <div class="w-full">
                <button
                  class="bg-orange-500 w-full py-2 rounded-md text-white hover:bg-orange-600 transition-all duration-300 hover:text-white"
                >
                  เปลื่ยนรหัสผ่าน
                </button>
              </div>
